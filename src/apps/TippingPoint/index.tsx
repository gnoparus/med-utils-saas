  ...
  return (
    <div className="relative overflow-hidden rounded-[2rem] border p-5" style={{ background: 'rgba(2,6,23,0.82)', borderColor: glow.border }}>
      <div
        ...
        style={{
          background: `
            radial-gradient(circle at 18% 18%, rgba(251,113,133,0.18), transparent 34%),
      ...
      <div className="relative flex items-center justify-between">
        <div>
          ...
          <div className="mt-1 text-sm font-bold text-white">{analysis.title}</div>
        </div>
        <motion.div
      ...
      <div className="relative mt-5 h-56">
        <div className="absolute left-1/2 top-2 h-28 w-1 -translate-x-1/2 rounded-full bg-slate-700/80" />
        <div className="absolute left-1/2 top-28 h-20 w-28 -translate-x-1/2 rounded-t-[999px] border border-white/8 bg-slate-900/70" />

        <motion.div
          className="absolute left-1/2 top-14 h-2 w-[16.5rem] -translate-x-1/2 rounded-full"
      ...
      <div className="relative mt-4 rounded-[1.6rem] border border-white/8 bg-white/[0.03] p-4">
        <div className="flex items-start justify-between gap-3">
          <div>
            <div className="text-[10px] font-bold uppercase tracking-[0.28em] text-slate-500">Call</div>
            <div className="mt-1 text-lg font-black tracking-tight text-white">{analysis.title}</div>
          ...
          <div className="rounded-2xl border border-white/8 bg-slate-950/80 px-3 py-2 text-center">
            <div className="text-[10px] font-bold uppercase tracking-[0.28em] text-slate-500">Net</div>
            <div className="mt-1 text-xl font-black tabular-nums" style={{ color: glow.accent }}>
...
function FieldCard({
  ...
  const meta = FIELD_META[field]
  const directionLabel = getFieldDirectionLabel(analysis, field)
  ...
  return (
    <motion.button
      ...
      className="relative overflow-hidden rounded-[1.6rem] border p-4 text-left"
      style={{
        background: active ? meta.accentBg : 'rgba(15,23,42,0.72)',
        borderColor: active ? `${meta.accent}66` : 'rgba(255,255,255,0.08)',
        boxShadow: active ? `0 0 22px ${meta.accent}22` : 'none',
      }}
    >
      <div
      ...
      />
      <div className="text-[10px] font-bold uppercase tracking-[0.28em] text-slate-500">{meta.label}</div>
      <div className="mt-3 flex items-baseline gap-1.5">
        ...
        {meta.unit && <span className="text-[11px] font-bold uppercase tracking-widest text-slate-500">{meta.unit}</span>}
      </div>
      <div className="mt-3 flex items-center justify-between">
        <span className="rounded-full border border-white/8 bg-white/[0.03] px-2.5 py-1 text-[10px] font-black uppercase tracking-[0.18em] text-slate-400">
          {directionLabel}
        </span>
        <div className="flex items-center gap-1 text-[10px] font-bold uppercase tracking-[0.18em] text-slate-500">
          {active ? 'Editing' : 'Tap'}
  ...
  return (
    <div className="h-screen w-screen overflow-hidden bg-slate-950 text-slate-100">
      ...
      <div className="relative flex h-full flex-col">
        <div className="shrink-0 px-4 pb-4 pt-12">
        ...
        <div className="flex-1 overflow-y-auto px-4 pb-8">
          ...
          <div className="mt-4 grid gap-3">
            <InsightCard title="Interpretation" icon={<Activity size={18} className="text-emerald-300" />}>
            ...
            <InsightCard title="Compensation" icon={<FlaskConical size={18} className="text-cyan-300" />}>
              <div className="flex items-start justify-between gap-3">
                <div>
            ...
            <InsightCard title="Copy Note" icon={<Sparkles size={18} className="text-emerald-300" />}>
              <p className="rounded-[1.5rem] border border-white/8 bg-slate-950/80 p-4 text-sm leading-relaxed text-slate-300">
                {analysis.chartNote}
              </p>
              <button
                id="copy-abg-note"
        ...
        <div className="shrink-0 border-t border-white/6 bg-slate-950/90 px-4 pb-[calc(env(safe-area-inset-bottom)+1rem)] pt-3 backdrop-blur-xl">
          <div className="mb-3 flex items-center justify-between">
            <div>
              <div className="text-[10px] font-bold uppercase tracking-[0.28em] text-slate-500">Custom Numpad</div>
